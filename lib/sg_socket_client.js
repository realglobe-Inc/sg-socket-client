...
const { CallExtension, LockExtension, WrapExtension } = require('./extensions')
const { CONNECT, CONNECT_ERROR, CONNECT_TIMEOUT, DISCONNECT } = ReservedEvents
...
function sgSocketClient (...args) {
  ...
  Object.assign(socket, CallExtension, LockExtension, WrapExtension, {
